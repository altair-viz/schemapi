...
SIMPLE_REF_TEMPLATE = '''# {{ cls.filename }}
# Auto-generated by altair_parser {{ date }}
...
class JSONSchema(object):
    ...
    simple_ref_template = SIMPLE_REF_TEMPLATE
    __draft__ = 4
