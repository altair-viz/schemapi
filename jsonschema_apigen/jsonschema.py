...
# Auto-generated by jsonschema_apigen: do not modify file directly
# - jsonschema_apigen version: {{version}}
# - date:    {{ date }}
"""
...
class JSONSchema(object):
    ...
    def source_tree(self, encoding='utf-8'):
        ...
        This can be passed to ``jsonschema_apigen.utils.load_dynamic_module``
        or to ``jsonschema_apigen.utils.save_module``
